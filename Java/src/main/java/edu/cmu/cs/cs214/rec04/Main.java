...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        printList(list1);
        System.out.println("List 1 total added: " + list1.getTotalAdded());

        // add 2 elements to a second list.
        list2.add(3);
        list2.add(0);

        System.out.println("List 2 total added before addAll: " + list2.getTotalAdded());
        // add the first list (5 elements) to our second list (2 elements).
        list2.addAll(list1);

        printList(list2);
        System.out.println("List 2 total added after addAll: " + list2.getTotalAdded());
    }
